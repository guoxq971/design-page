  ...
  <div class="list-container">
    <div class="box-list">
      ...
      <div class="list" v-else>
        <div class="box-wrap" v-for="item in list" :key="'myImage' + item.seqId" @click="onSetImage(item)">
          <boxContainer v-if="item.previewImg" style="background-color: rgb(245, 247, 250)" @mouseleave="mouseleave" @mouseenter="mouseenter" :detail="item" :src="item.previewImg" />

          <boxContainer v-else style="background-color: rgb(245, 247, 250)" @mouseleave="mouseleave" @mouseenter="mouseenter" :detail="item" :src="item.designImg" />
        </div>
