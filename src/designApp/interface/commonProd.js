 ...
 * 使用到的数据
 * @class
 * @param {string} seqId 主键
 * @param {string} templateName 模板名称
 * @param {string} templateNo 模板编号
 * @param {string} templateNameShow 模板显示的title
 * @param {string} templateModel 模板型号
 * @param {number} dpi dpi
 * @param {boolean} imgFull 是否全幅
 * @param {Array} views 视图
 * @param {Array} appearances 颜色
 * @param {Array} sizes 尺码
 * @param {Array} printAreas 印刷区域
 * @param {Array} pointoutPrintAreas 指定印刷区域
 * */
...
// 通用产品
export class CommonProdItem extends NoUseProdDetail {}
